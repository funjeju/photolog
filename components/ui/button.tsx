...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-primary-300 text-white hover:bg-primary-400 active:scale-95 rounded-full',
        destructive:
          'bg-coral-300 text-white hover:bg-coral-200 rounded-full',
        outline:
          'border-2 border-primary-200 text-primary-500 hover:bg-primary-50 rounded-full',
        secondary:
          'bg-background-subtle text-foreground hover:bg-primary-100 rounded-full',
        ghost:
          'text-foreground hover:bg-background-subtle rounded-full',
        link:
